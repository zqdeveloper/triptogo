    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <tr>
            <td style="visibility: hidden;">
                <input id="lat" name="wr_1" type="hidden">
                <input id="lng" name="wr_2" type="hidden">
            </td>
            <td colspan="2" class="cont_td">
                <input id="pac-input" class="controls" type="text" placeholder="Enter a location" value="<?php echo $write['placeName']; ?>"/>
                <div style="background-color:#f9f9f9; width:100%; margin-top:5px; height:500px; border-radius:4px;"
                     id="map"></div>
                ...
                <script>
                    function initMap() {
                        const uluru = { lat: <?php echo $write['wr_1']!= '' ? $write['wr_1']: 12.97;?>, lng: <?php echo $write['wr_2']?$write['wr_2']: 77.59 ; ?>}
                        ...
                        autocomplete.addListener("place_changed", () => {
                            ...
                            geocoder.geocode({placeId: place.place_id}, (result, status) => {
                                ...
                                console.log(lat.value, lng.value, place.name);
